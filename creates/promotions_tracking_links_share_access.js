...
module.exports = {
  key: 'promotions_tracking_links_share_access',
  noun: 'Access',
  display: {
    label: 'Share tracking link access',
    description: 'Share tracking link access with a user **Permission Required:** `promotions:write`',
  },
  operation: {
    inputFields: [
    {
