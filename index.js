...
const analyticsMassMessagesSentTrigger = require('./triggers/analytics_mass_messages_sent');
...
module.exports = {
  ...
  triggers: {
    ...
    [analyticsMassMessagesSentTrigger.key]: analyticsMassMessagesSentTrigger,
