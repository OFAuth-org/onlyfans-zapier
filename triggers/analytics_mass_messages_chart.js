...
module.exports = {
  key: 'analytics_mass_messages_chart',
  noun: 'Chart',
  display: {
    label: 'Mass messages chart',
    description: 'Get time-series mass message performance data **Permission Required:** `analytics:read`',
  },
  operation: {
    inputFields: [
    {
