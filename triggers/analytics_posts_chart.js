const perform = async (z, bundle) => {
  const response = await z.request({
    url: 'https://api-next.ofauth.com/v2/access/analytics/posts/chart',
    method: 'GET',
    headers: {
...
module.exports = {
  key: 'analytics_posts_chart',
  noun: 'Chart',
  display: {
    label: 'Posts chart',
    description: 'Get time-series post performance data **Permission Required:** `analytics:read`',
  },
  operation: {
    inputFields: [
    {
    ...
    },
    {
      ...
      type: 'string',
      required: false,
      choices: ['purchases', 'posts', 'tips', 'views', 'likes', 'comments'],
