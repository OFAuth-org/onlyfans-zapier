const perform = async (z, bundle) => {
  const response = await z.request({
    url: 'https://api-next.ofauth.com/v2/access/analytics/promotions/chart',
    method: 'GET',
    headers: {
...
module.exports = {
  key: 'analytics_promotions_chart',
  noun: 'Chart',
  display: {
    label: 'Promotions chart',
    description: 'Get time-series promotion performance data **Permission Required:** `analytics:read`',
  },
  operation: {
    inputFields: [
    {
