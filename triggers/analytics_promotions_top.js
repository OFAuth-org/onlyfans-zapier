const perform = async (z, bundle) => {
  const response = await z.request({
    url: 'https://api-next.ofauth.com/v2/access/analytics/promotions/top',
    method: 'GET',
    headers: {
...
module.exports = {
  key: 'analytics_promotions_top',
  noun: 'Top',
  display: {
    label: 'Top promotions',
    description: 'Get top performing promotions **Permission Required:** `analytics:read`',
  },
  operation: {
    inputFields: [
    {
